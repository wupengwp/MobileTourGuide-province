...
public class MyAlertDialogto {
	...
	public MyAlertDialogto(Context context) {
	...
	public MyAlertDialogto builder() {
		// ��ȡDialog����
	...
	public MyAlertDialogto setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
			txt_title.setText("����");
		} else {
	...
	public MyAlertDialogto setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public MyAlertDialogto setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("����");
		} else {
	...
	public MyAlertDialogto setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public MyAlertDialogto setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public MyAlertDialogto setPositiveButton(String text,
	...
	public MyAlertDialogto setNegativeButton(String text,
			final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("ȡ��");
