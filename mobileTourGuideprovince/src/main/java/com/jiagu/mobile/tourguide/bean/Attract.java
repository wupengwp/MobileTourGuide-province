...
public class Attract implements Serializable {
	...
	public static final int SPOTMARKING = 1;
	public static final int REGIONMARKING = 2;
	public static final int PATHMARKING = 3;
	...
	public Attract(JSONObject attract) throws JSONException {
		...
		this.voiceURL = Path.AUDIO_PATH+attract.optString("voiceURL");
		
		//FileTools.writeLog("realtime.txt", voiceURL);
		
		//this.imageURL = attract.optString("imageURL");
		
		//this.voiceURL = "http://www.shoujidaoyou.cn/sound/app/scenic/S0001/attract/gongsijianjie.wav";
