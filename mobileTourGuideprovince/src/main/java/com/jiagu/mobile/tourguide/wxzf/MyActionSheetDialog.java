...
public class MyActionSheetDialog {
	...
	public MyActionSheetDialog builder() {
		...
		// ����Dialog��С���Ϊ��Ļ���
		view.setMinimumWidth((int)(display.getWidth()*0.85));
	 ...
	 * @return
	 */
	public MyActionSheetDialog addSheetItem(String[] tcitems, SheetItemColor color,
			OnSheetItemClickListener listener) {
		if (sheetItemList == null) {
			sheetItemList = new ArrayList<SheetItem>();
		}
		for (int i = 0; i < tcitems.length; i++) {
			sheetItemList.add(new SheetItem(tcitems[i], color, listener));
		}
